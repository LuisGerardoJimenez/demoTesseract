...
public class EjecutarPruebaBs {
	...
	public static void ejecutarPruebaAutomatica(String rutaReporte,CasoUso casoUso,String rutaFolder) {
		try {
            ...
            String[] cmd = { "/bin/sh", "-c", "cd /Users/erramanivelascorosete/Downloads/apache-jmeter-3.0/bin; "+comando};
                ...
                if(line.indexOf("#errorsTable") != -1){
                	...
                	try{
	                	...
	                	for(int i=0;i<results.size();i++){
                		    ...
                		    String comando2 = "rm /Users/erramanivelascorosete/Downloads/apache-jmeter-3.0/bin/Test.jtl";
