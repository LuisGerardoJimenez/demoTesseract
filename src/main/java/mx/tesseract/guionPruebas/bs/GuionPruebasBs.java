package mx.tesseract.guionPruebas.bs;
...
import mx.tesseract.bs.TipoReglaNegocioEnum;
import mx.tesseract.bs.TipoReglaNegocioEnum.TipoReglaNegocioENUM;
...
import mx.tesseract.editor.dao.TipoReglaNegocioDAO;
...
import mx.tesseract.generadorPruebas.dao.ValorDesconocidoDAO;
...
import mx.tesseract.guionPruebas.dao.GuionPruebaDAO;
import mx.tesseract.guionPruebas.dao.InstruccionDAO;
import mx.tesseract.guionPruebas.dao.VerboSinonimoDAO;
...
import mx.tesseract.guionPruebas.model.VerboSinonimo;
...
public static List<String> obtenerInstrucciones(CasoUso casoUso, List<Trayectoria> trayectorias, String contextPath) {
    ...
    for(int a=0; a<trayectorias.size(); a++){
      ...
      //Agregamos los pasos de la trayectoria 
        if(trayectoriaPrincipal.isAlternativa()){
