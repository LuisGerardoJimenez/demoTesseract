...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que la regla de negocio pueda modificarse con base en la regla de negocio \BRref{RN5}{Modificación de elementos asociados a casos de uso liberados}. \Trayref{MBR-H}
		...
		\UCpaso[\UCsist] Verifica que el nombre de la regla de negocio no se encuentre registrado en el sistema con base en la regla de negocio \BRref{RN6}{Unicidad de nombres}. \Trayref{MBR-D}
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \Trayref{MBR-E}
		\UCpaso[\UCsist] Verifica que el nombre de la regla de negocio no contenga caracteres inválidos con base en la regla de negocio \BRref{RN2}{Nombres de los elementos}. \Trayref{MBR-F}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{MBR-A}{El actor desea cancelar la operación.}
	...
	\begin{UCtrayectoriaA}{MBR-D}{El actor ingresó un nombre de regla de negocio repetido.}
	...
	\begin{UCtrayectoriaA}{MBR-E}{El actor proporciona un dato que excede la longitud máxima.}
	...
	\begin{UCtrayectoriaA}{MBR-F}{El actor ingresó un nombre con caracteres inválidos.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG18}{Caracteres inválidos} y señala el campo que contiene los caracteres inválidos en la pantalla \IUref{IU9.2}{Modificar Regla de negocio}.
	\UCpaso Regresa al paso \ref{CU8.2-P5} de la trayectoria principal.
	\end{UCtrayectoriaA}
	...
	\begin{UCtrayectoriaA}{MBR-H}{La regla de negocio no puede modificarse debido a que se encuentra asociada a casos de uso liberados.}
