...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Solicita guardar la información del término oprimiendo el botón \IUbutton{Aceptar} de la pantalla \IUref{IU11.1}{Registrar Término}. \Trayref{A}
