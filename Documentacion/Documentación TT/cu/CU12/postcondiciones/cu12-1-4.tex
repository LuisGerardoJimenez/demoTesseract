...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Solicita registrar la postcondición oprimiendo el botón \IUbutton{Aceptar} de la pantalla \IUref{IU6.1.3}{Registrar Postcondición}. \Trayref{RPOST-L} 
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{RPOST-L}{El actor desea cancelar la operación.}
		\UCpaso[\UCactor] Solicita cancelar la operación oprimiendo el botón \IUbutton{Cancelar} de la pantalla \IUref{IU6.1.3}{Registrar postcondición}.
	...
	\begin{UCtrayectoriaA}{-M}{El actor no ingresó algún dato marcado como obligatorio.}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG4}{Dato obligatorio} y señala el campo que presenta el error en la pantalla \IUref{IU6.1.3}{Registrar postcondición}, indicando al actor que el dato es obligatorio.
	...
	\begin{UCtrayectoriaA}{RPOST-N}{El actor proporciona un dato que excede la longitud máxima.}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Longitud inválida} y señala el campo que excede la longitud en la pantalla \IUref{IU6.1.3}{Registrar postcondición}, para indicar que el dato excede el tamaño máximo permitido.
		\UCpaso Regresa al paso \ref{CU12.1.4-P3} de la trayectoria principal.
	\end{UCtrayectoriaA}
