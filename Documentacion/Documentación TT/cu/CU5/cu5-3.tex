...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Confirma la eliminación del módulo oprimiendo el botón \IUbutton{Aceptar}. \Trayref{EM-A}
		\UCpaso[\UCsist] Verifica que el módulo pueda eliminarse, con base en la regla de negocio \BRref{RN28}{Eliminación de módulos}. \Trayref{EM-B}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{EM-A}{El actor desea cancelar la operación.}
	...
	\begin{UCtrayectoriaA}{EM-B}{No es posible eliminar el módulo.}
