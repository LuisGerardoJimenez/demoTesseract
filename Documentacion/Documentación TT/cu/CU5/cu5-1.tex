	\begin{UseCase}{CU5.1}{Registrar Módulo}{
		...
		\begin{itemize}
			...
			\item \cdtRef{moduloEntidad:descripcionModulo}{Descripción:} Se selecciona de un calendario.
		\end{itemize}	
		}
		...
		\UCitem{Tipo}{Secundario, extiende del caso de uso \UCref{CU4}{Gestionar Módulos}.}
	\end{UseCase}
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Solicita registrar un proyecto oprimiendo el botón \IUbutton{Registrar} de la pantalla \IUref{IU4}{Gestionar Módulos}.
		...
		\UCpaso[\UCactor] Solicita guardar el proyecto oprimiendo el botón \IUbutton{Aceptar} de la pantalla \IUref{IU4.1}{Registrar Módulo}. \Trayref{A}
