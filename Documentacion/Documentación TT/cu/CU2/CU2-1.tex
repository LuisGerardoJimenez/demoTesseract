	\begin{UseCase}{CU2.1}{Registrar proyecto}{
			...
			Permite al {\hyperlink{admin}{Administrador}} registrar la información general de un proyecto, dicha información está comprendida por: una  \cdtRef{proyectoEntidad:claveProyecto}{clave} y un {proyectoEntidad:nombreProyecto}{nombre} como medio de identificación, una descripción de objetivos y características relevantes, se establece un periódo de tiempo solicitando la fecha de inicio y término, fecha de inicio y término programadas, contraparte, presupuesto y estado en el que se encuentra, del mismo modo tiene asociado un líder el cual ejecutará las actividades de asociación de colaboradores una vez registrado el proyecto, así como las de terminar, revisar y liberar casos de uso. 
