...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que exista información referente a los estados de un proyecto, con base en la regla de negocio \BRref{RN20}{Verificación de catálogos}. \Trayref{MP-A}
		\UCpaso[\UCsist] Verifica que exista al menos un colaborador, con base en la regla de negocio \BRref{RN20}{Verificación de catálogos}. \Trayref{MP-B}
		...
		\UCpaso[\UCactor] Solicita guardar el proyecto oprimiendo el botón \IUbutton{Aceptar} de la pantalla \IUref{IU2.2}{Modificar proyecto}. \Trayref{MP-C}
		\UCpaso[\UCsist] Verifica que el actor ingrese todos los campos obligatorios con base en la regla de negocio \BRref{RN8}{Datos obligatorios}. \Trayref{MP-D}
		\UCpaso[\UCsist] Verifica que el nombre del proyecto no se encuentre registrado en el sistema con base en la regla de negocio \BRref{RN6}{Unicidad de nombres}. \Trayref{MP-E}
		\UCpaso[\UCsist] Verifica que la clave del proyecto no se encuentre registrada en el sistema con base en la regla de negocio \BRref{RN22}{Unicidad de la clave del Proyecto}. \Trayref{MP-F}
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \Trayref{MP-G} \Trayref{MP-H}
		\UCpaso[\UCsist] Verifica que la fecha de término sea posterior a la fecha de inicio. \Trayref{MP-I}
		\UCpaso[\UCsist] Verifica que la fecha de término programada sea posterior a la fecha de inicio programada. \Trayref{MP-J}
	...
	\end{UCtrayectoria}		
%--------------------------------------
		\begin{UCtrayectoriaA}{MP-A}{No hay estados con los que puede iniciar un proyecto}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{MP-E}{El actor ingresó un nombre de proyecto repetido.}
	...
	\begin{UCtrayectoriaA}{MP-F}{El actor ingresó una clave de proyecto repetida.}
	...
	\begin{UCtrayectoriaA}{MP-G}{El actor proporciona un dato que excede la longitud máxima.}
	...
	\begin{UCtrayectoriaA}{MP-H}{El actor ingresó un tipo de dato incorrecto.}
	...
	\begin{UCtrayectoriaA}{MP-I}{El actor ingresó una fecha de término que no es posterior a la fecha de inicio.}
	...
	\begin{UCtrayectoriaA}{MP-J}{El actor ingresó una fecha de término programada que no es posterior a la fecha de inicio programada.}
