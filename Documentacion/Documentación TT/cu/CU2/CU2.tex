	\begin{UseCase}{CU2}{Gestionar proyectos de Administrador}{
		...
		La gestión está disponible en cualquier estado en el que se encuentre el proyecto con base en el  \hyperlink{sec:diagramaEstados}{Modelo de estados del proyecto}.
