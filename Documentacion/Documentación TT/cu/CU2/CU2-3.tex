...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que el proyecto pueda eliminarse, con base en la regla de negocio \BRref{RN34}{Eliminación de proyectos}. \Trayref{B}
...
%--------------------------------------
		\begin{UCtrayectoriaA}{B}{No es posible eliminar el proyecto.}
			\UCpaso[\UCsist] Muestra la pantalla \IUref{IU2}{Gestionar proyectos de Administrador} con el mensaje \cdtIdRef{MSG13}{Eliminación no permitida}.
		\end{UCtrayectoriaA}