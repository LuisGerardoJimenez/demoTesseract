	\begin{UseCase}{CU1}{Iniciar sesión}{
		El actor ingresa con su correo electrónico y contraseña a su perfil para hacer uso de las funciones que le competen.
	}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica el rol que tiene el usuario con base a la regla de negocio \BRref{RN39}{Roles del sistema}. \hyperlink{CU1:TAF}{[Trayectoria F]} \hyperlink{CU1:TAG}{[Trayectoria G]}
