...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{EC-B}{La asociación del colaborador falló.}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG12}{Ha ocurido un error} en la pantalla \IUref{IU5}{Gestionar Proyectos de Colaborador} para indicar que no hay registros para mostrar.
	\end{UCtrayectoriaA}
