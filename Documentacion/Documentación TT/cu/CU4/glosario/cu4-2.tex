	\begin{UseCase}{CU4.2}{Gestionar Términos}{
	Este caso de uso permite al analista visualizar los registros de los términos registrados en el sistema. También permite al actor acceder a las operaciones de registro, consulta, modificación, y eliminación de un término del glosario.
	}
	\UCitem{Versión}{\color{Gray}0.1}
	\UCitem{Actor}{\hyperlink{jefe}{Líder de análisis}, \hyperlink{jefe}{Líder de análisis}}
	\UCitem{Propósito}{Proporcionar al actor un mecanismo para llevar el control de los términos del negocio.}
	\UCitem{Entradas}{Ninguna}
	\UCitem{Salidas}{\begin{itemize}
			\item \cdtRef{proyectoEntidad:claveProyecto}{Clave del proyecto}: Lo obtiene el sistema.
			\item \cdtRef{proyectoEntidad:nombreProyecto}{Nombre del proyecto}: Lo obtiene el sistema.
			\item \cdtRef{terminoGLSEntidad}{Término de glosario}: Tabla que muestra \cdtRef{terminoGLSEntidad:claveTGLS}{Clave}, y el \cdtRef{terminoGLSEntidad:nombreTGLS}{Nombre} de todos los registros de los términos.
			\item \cdtIdRef{MSG2}{No existe información}: Se muestra en la pantalla \IUref{IU10}{Gestionar proyectos de Administrador} cuando no existe personal registrado.
	\end{itemize}}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Obtiene la información del personal registrado. \Trayref{A}
