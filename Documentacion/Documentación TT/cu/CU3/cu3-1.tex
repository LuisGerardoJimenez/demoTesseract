...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \Trayref{RPE-C} \Trayref{RPE-D}
		\UCpaso[\UCsist] Verifica que la CURP ingresada sea válida con base en la regla de negocio \BRref{RN33}{Longitud de la CURP}. \Trayref{RPE-E}
		\UCpaso[\UCsist] Verifica que la CURP de persona no se encuentre registrado en el sistema con base en la regla de negocio \BRref{RN6}{Unicidad de nombres}. \Trayref{RPE-F}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{RPE-F}{El actor ingresó una CURP repetida.}
