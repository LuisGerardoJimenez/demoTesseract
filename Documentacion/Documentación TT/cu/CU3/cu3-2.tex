...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que el correo electrónico y la contraseña de la persona no hayan cambiado. \Trayref{MPE-E}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{MPE-E}{El actor modificó el correo electrónico o la contraseña.}
