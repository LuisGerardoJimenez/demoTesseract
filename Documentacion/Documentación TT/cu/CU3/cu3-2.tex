...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que la CURP ingresada sea válida con base en la regla de negocio \BRref{RN33}{Longitud de la CURP}. \Trayref{MPE-C}
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \Trayref{MPE-D} \Trayref{MPE-E}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{MPE-C}{El actor ingresó una CURP con una longitud incorrecta.}
	...
	\begin{UCtrayectoriaA}{MPE-D}{El actor proporciona un dato que excede la longitud máxima.}
	...
	\begin{UCtrayectoriaA}{MPE-E}{El actor ingresó un tipo de dato incorrecto.}
