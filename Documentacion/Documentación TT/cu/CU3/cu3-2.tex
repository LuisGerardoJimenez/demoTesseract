...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que el correo electrónico y la contraseña de la persona no hayan cambiado. \Trayref{F}
...
%--------------------------------------
	...
	\begin{UCtrayectoriaA}{F}{El actor modificó el correo electrónico o la contraseña.}
