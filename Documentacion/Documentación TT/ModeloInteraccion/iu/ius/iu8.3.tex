%--------------------------------------
\subsection{IU 8.3 Consultar Actor}

\subsection{Objetivo}
	Esta pantalla permite al actor consultar la información de un actor.
\subsection{Diseño}
	En la figura \IUref{IU8.3}{Consultar Actor} se muestra la pantalla ''Consultar Actor'' que permite consultar la información de un actor.
