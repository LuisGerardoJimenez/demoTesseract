%--------------------------------------
\section{IU 4.1 Registrar Módulo}

\subsection{Objetivo}
	Esta pantalla permite al actor registrar la información de un módulo.
\subsection{Diseño}
	En la figura \IUref{IU4.1}{Registrar módulo} se muestra la pantalla ''Registrar Módulo'' que permite al actor registrar un módulo. En la esquina superior derecha de la pantalla, el sistema mostrará la clave y el nombre del proyecto en el cual se está realizando el registro del módulo.
...
\IUfig[1]{interfaces/IU4-1registrarModulo}{IU4.1}{Registrar Módulo}
\subsection{Comandos}
\begin{itemize}
