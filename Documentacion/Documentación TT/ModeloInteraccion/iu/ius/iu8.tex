...
\begin{itemize}
	...
	\item \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} [Consultar]: Permite al actor solicitar la consulta de un actor, dirige a la pantalla  \IUref{8.3}{Consultar Actor}.
\end{itemize}
\subsection{Mensajes}
