%--------------------------------------
\section{IU 3.2 Modificar Persona}

\subsection{Objetivo}
	Esta pantalla permite al actor modificar la información de una persona.
\subsection{Diseño}
	En la figura \IUref{IU3.2}{Modificar Persona} se muestra la pantalla ''Modificar persona'' que permite al actor modificar la información de una persona.
...
\IUfig[1]{interfaces/IU3-2modificarPersona}{IU3.2}{Modificar Persona}
\subsection{Comandos}
\begin{itemize}
...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \IUref{IU3.2}{Modificar persona} cuando se registre una persona con una CURP que ya exista.
\end{Citemize}
