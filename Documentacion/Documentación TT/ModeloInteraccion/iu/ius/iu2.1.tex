...
\subsection{Diseño}
	En la figura \IUref{IU2.1}{Registrar Proyecto} se muestra la pantalla ''Gestionar proyectos de Administrador'' que permite al actor registrar un proyecto.
...
\IUfig[1]{interfaces/IU2-1_RegistrarProyecto}{IU2.1}{Registrar Proyecto}
\subsection{Comandos}
\begin{itemize}
