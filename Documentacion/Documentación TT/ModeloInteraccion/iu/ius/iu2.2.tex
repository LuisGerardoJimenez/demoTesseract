%--------------------------------------
\section{IU 2.2 Modificar Proyecto}

\subsection{Objetivo}
	Esta pantalla permite al actor modificar la información de un proyecto.
\subsection{Diseño}
	En la figura \IUref{IU2.2}{Modificar proyecto} se muestra la pantalla ''Modificar proyecto'' que permite al actor modificar un proyecto.
...
\IUfig[1]{interfaces/IU2-2ModificarProyecto}{IU2.2}{Modificar Proyecto}
\subsection{Comandos}
\begin{itemize}
