...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Busca la información de los proyectos registrados en cualquier estado. \Trayref{GPA}
	...
	\end{UCtrayectoria}		
%--------------------------------------
		\begin{UCtrayectoriaA}{GPA}{No existen registros de proyectos}
